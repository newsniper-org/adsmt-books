// adsmt — Implement from Scratch (English)
// Compile: typst compile main.typ

#set document(
  title: "adsmt: Implement from Scratch",
...
#align(center)[
  ...
  #v(0.5cm)
  #text(size: 20pt)[Implement from Scratch]
  #v(2cm)
  #text(size: 14pt, style: "italic")[
    A guided construction of an abductive-deductive\
    HOL+HKT SMT solver
  ]
  #v(4cm)
